...
export function ArrowDown({ className, size = 13 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FlowerIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PauseIcon({ className, size = 10 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
